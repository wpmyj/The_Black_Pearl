...
#define	LCD_RS_SET	GPIOD->BSRR=1<<14    //数据/命令          	   
#define	LCD_WR_SET	GPIOD->BSRR=1<<13    //写数据			 
#define	LCD_RD_SET	GPIOD->BSRR=1<<15    //读数据			 
								    
#define	LCD_CS_CLR  GPIOD->BRR=1<<12     //片选端口  	     
#define	LCD_RS_CLR	GPIOD->BRR=1<<14     //数据/命令          	   
#define	LCD_WR_CLR	GPIOD->BRR=1<<13     //写数据			 
#define	LCD_RD_CLR	GPIOD->BRR=1<<15     //读数据
